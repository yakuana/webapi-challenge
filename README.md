...
- [x] Mention two parts of Express that you learned about this week.
    ...
    - Routing is one of the main features of express and can map incoming request to the appropriate request handler. 
...
- [x] What can the API return to help clients know if a request was successful?
    ...
    We return HTTP status code 201 (Created), 200 (Removed), or 204 (No Content) when requests are successful  
